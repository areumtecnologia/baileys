...
declare class NodeCacheStore<T> extends Hookified {
     ...
     */
    get<V = T>(key: string | number): Promise<V | undefined>;
    /**
     * Get multiple values from the cache.
     * @param {Array<string | number>} keys
     * @returns {Record<string, any | undefined>}
     */
    mget<V = T>(keys: Array<string | number>): Promise<Record<string, V | undefined>>;
    /**
     ...
     * @returns {T | undefined}
     */
    take<V = T>(key: string | number): Promise<V | undefined>;
    /**
...
declare class NodeCache<T> extends Hookified {
     ...
     */
    take<V = T>(key: string | number): V | undefined;
    /**
